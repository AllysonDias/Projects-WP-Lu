	...
	protected function render_content() {
		...
		<label>
			...
			<select class="avadanta-typography-select" <?php $this->link(); ?>>
				...
				if ( $std_fonts = bovity_standard_fonts() ) { ?>
					<optgroup label="<?php esc_attr_e( 'Fonts List', 'bovity' ); ?>">
						<?php
				...
				<?php } 
				if ( $google_fonts = bovity_google_fonts_array() ) { ?>
					<optgroup label="<?php esc_attr_e( 'Google Fonts', 'bovity' ); ?>">
						<?php
						// Loop through font options and add to select
