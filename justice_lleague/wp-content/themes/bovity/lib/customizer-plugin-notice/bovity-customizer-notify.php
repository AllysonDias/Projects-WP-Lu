...
class Avadanta_Customizer_Notify {
	...
	public function avadanta_customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'bovity-customizer-notify-css', get_template_directory_uri() . '/lib/customizer-plugin-notice/css/bovity-customizer-notify.css', array());

		wp_enqueue_style( 'bovity-plugin-install' );
		wp_enqueue_script( 'bovity-plugin-install' );
		wp_add_inline_script( 'bovity-plugin-install', 'var pagenow = "customizer";' );

		wp_enqueue_script( 'bovity-updates' );

		wp_enqueue_script( 'bovity-customizer-notify-js', get_template_directory_uri() . '/lib/customizer-plugin-notice/js/bovity-customizer-notify.js', array( 'customize-controls' ));
		wp_localize_script(
			'bovity-customizer-notify-js', 'AvadantaCustomizercompanionObject', array(
				...
				'avadanta_activating_string'  => __( 'Activating', 'bovity' ),
			)
		);
	...
	public function avadanta_plugin_notification_customize_register( $wp_customize ) {
		...
		require_once get_template_directory() . '/lib/customizer-plugin-notice/bovity-customizer-notify-section.php';
